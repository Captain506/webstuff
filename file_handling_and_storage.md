...
<head>
    <script defer data-domain="champagne.pages.dev" data-api="https://aaoo.ooaa.workers.dev/oooa/event" src="https://aaoo.ooaa.workers.dev/aaao/script.js"></script>

    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width,initial-scale=1">
    <meta name="turbo-cache-control" content="no-cache" data-turbo-track="reload" data-track-token="3.0.3.767553606804">

    <script defer src="https://cloud.umami.is/script.js" data-website-id="b7f40c03-1675-4255-a9f7-c673e47cbaf0"></script>
    <meta name="generator" content="Retype 3.0.3">

    <!-- Primary Meta Tags -->
    <title>File Hosting &amp; Storage - Champagne.</title>
    <meta name="title" content="File Hosting & Storage - Champagne.">
    <meta name="description" content="Discover top websites for file storage, hosting and quick temporary sharing in our curated directory." />

    <!-- Canonical -->
    <link rel="canonical" href="https://champagne.pages.dev/non-piracy-stuff/storage/" />

    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="https://champagne.pages.dev/non-piracy-stuff/storage/">
    <meta property="og:title" content="File Hosting & Storage - Champagne.">
    <meta property="og:description" content="Discover top websites for file storage, hosting and quick temporary sharing in our curated directory.">

    <!-- Twitter -->
    <meta property="twitter:card" content="summary_large_image">
    <meta property="twitter:url" content="https://champagne.pages.dev/non-piracy-stuff/storage/">
    <meta property="twitter:title" content="File Hosting & Storage - Champagne.">
    <meta property="twitter:description" content="Discover top websites for file storage, hosting and quick temporary sharing in our curated directory.">

    <script>(function () { var el = document.documentElement, m = localStorage.getItem("doc_theme"), wm = window.matchMedia; if (m === "dark" || (!m && wm && wm("(prefers-color-scheme: dark)").matches)) { el.classList.add("dark") } else { el.classList.remove("dark") } })();</script>

    <link href="../../static/champagnewiki.png" rel="icon" />
    <link href="../../resources/css/retype.css?v=3.0.3.767553606804" rel="stylesheet" />

    <script type="text/javascript" src="../../resources/js/config.js?v=3.0.3.767553606804" data-turbo-eval="false" defer></script>
    <script type="text/javascript" src="../../resources/js/retype.js?v=3.0.3" data-turbo-eval="false" defer></script>
    <script id="lunr-js" type="text/javascript" src="../../resources/js/lunr.js?v=3.0.3.767553606804" data-turbo-eval="false" defer></script>
</head>
<body>
                ...
                <div class="flex items-center justify-between h-full py-2 md:w-75">
                    <div class="flex items-center px-2 md:px-6">
                        <a id="docs-site-logo" href="../../" class="flex items-center leading-snug text-2xl">
                            <span class="dark:text-white font-semibold line-clamp-1 md:line-clamp-2">CHAMPAGNE</span>
                ...
                <div class="flex justify-between md:grow">
                    ...
                    <nav class="hidden md:flex">
                        <ul class="flex flex-col mb-4 md:pl-16 md:mb-0 md:flex-row md:items-center">
                            <li class="mr-6">
                                <a class="py-2 md:mb-0 inline-flex items-center text-sm whitespace-nowrap transition-colors duration-200 ease-linear md:text-blue-500 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-200" href="https://discord.gg/cH3ZkVc3Gd" target="_blank">
                                    <img class="mb-px mr-1" width="18" alt="" src="../../static/discord.svg" />
                                    <span>Discord</span>
                                </a>
                            </li>
                            <li class="mr-6">
                                <a class="py-2 md:mb-0 inline-flex items-center text-sm whitespace-nowrap transition-colors duration-200 ease-linear md:text-blue-500 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-200" href="https://t.me/WeCHAMPAGNE" target="_blank">
                                    <img class="mb-px mr-1" width="18" alt="" src="../../static/telegram.svg" />
                                    <span>Telegram</span>
                                </a>
                            </li>
                            <li class="mr-6">
                                <a class="py-2 md:mb-0 inline-flex items-center text-sm whitespace-nowrap transition-colors duration-200 ease-linear md:text-blue-500 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-200" href="https://rentry.org/champagne_wiki" target="_blank">
                                    <img class="mb-px mr-1" width="18" alt="" src="../../static/rentry.svg" />
                                    <span>Wiki on Rentry</span>
                                </a>
                            </li>
                            <li class="mr-6">
                                <a class="py-2 md:mb-0 inline-flex items-center text-sm whitespace-nowrap transition-colors duration-200 ease-linear md:text-blue-500 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-200" href="https://champagne.pages.dev/piracy-guides/reddit-no-ads/" target="_blank">
                                    <img class="mb-px mr-1" width="18" alt="" src="../../static/reddit.png" />
                                    <span>Tweaked Reddit</span>
                                </a>
                            </li>
                            <li class="mr-6">
                                <a class="py-2 md:mb-0 inline-flex items-center text-sm whitespace-nowrap transition-colors duration-200 ease-linear md:text-blue-500 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-200" href="https://champagne.pages.dev/online-streaming--dl/general-streaming/#downloads" target="_blank">
                                    <span class="docs-emoji mr-1">🧲</span>
                                    <span>RARBG Alternatives</span>
                                </a>
                            </li>
                        ...
                        <div class="py-3 px-6 md:hidden border-b dark:border-dark-650">
                            <nav>
                                <ul class="flex flex-wrap justify-center items-center">
                                    <li class="mr-6">
                                        <a class="block py-1 inline-flex items-center text-sm whitespace-nowrap transition-colors duration-200 ease-linear md:text-blue-500 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-200" href="https://discord.gg/cH3ZkVc3Gd" target="_blank">
                                            <img class="mb-px mr-1" width="18" alt="" src="../../static/discord.svg" />
                                            <span>Discord</span>
                                        </a>
                                    </li>
                                    <li class="mr-6">
                                        <a class="block py-1 inline-flex items-center text-sm whitespace-nowrap transition-colors duration-200 ease-linear md:text-blue-500 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-200" href="https://t.me/WeCHAMPAGNE" target="_blank">
                                            <img class="mb-px mr-1" width="18" alt="" src="../../static/telegram.svg" />
                                            <span>Telegram</span>
                                        </a>
                                    </li>
                                    <li class="mr-6">
                                        <a class="block py-1 inline-flex items-center text-sm whitespace-nowrap transition-colors duration-200 ease-linear md:text-blue-500 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-200" href="https://rentry.org/champagne_wiki" target="_blank">
                                            <img class="mb-px mr-1" width="18" alt="" src="../../static/rentry.svg" />
                                            <span>Wiki on Rentry</span>
                                        </a>
                                    </li>
                                    <li class="mr-6">
                                        <a class="block py-1 inline-flex items-center text-sm whitespace-nowrap transition-colors duration-200 ease-linear md:text-blue-500 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-200" href="https://champagne.pages.dev/piracy-guides/reddit-no-ads/" target="_blank">
                                            <img class="mb-px mr-1" width="18" alt="" src="../../static/reddit.png" />
                                            <span>Tweaked Reddit</span>
                                        </a>
                                    </li>
                                    <li class="mr-6">
                                        <a class="block py-1 inline-flex items-center text-sm whitespace-nowrap transition-colors duration-200 ease-linear md:text-blue-500 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-200" href="https://champagne.pages.dev/online-streaming--dl/general-streaming/#downloads" target="_blank">
                                            <span class="docs-emoji mr-1">🧲</span>
                                            <span>RARBG Alternatives</span>
                                        </a>
                                    </li>
                    ...
                    <div class="min-w-0 p-4 grow md:px-16">
                        <main class="relative pb-12 lg:pt-2">
                            <div class="docs-markdown" id="docs-content">
                                ...
                                <!-- Page content  -->
<doc-anchor-target id="file-hosting--storage" class="break-words">
    <h1>
        <doc-anchor-trigger class="header-anchor-trigger" to="#file-hosting--storage">#</doc-anchor-trigger>
        <span>File Hosting &amp; Storage</span>
    </h1>
</doc-anchor-target>
<hr />
...
<li><a href="https://justbeamit.com/">Just Beam It</a> <span class="no-link inline-flex items-center justify-center font-medium leading-none whitespace-nowrap text-blue-600 bg-blue-100 h-4.5 px-1.5 text-3xs rounded">
    <span>Uses your internet.</span>
                            ...
                            <footer class="clear-both">
                                ...
                                <nav class="flex mt-14">
                                    <div class="w-1/2">
                                        <a class="px-5 py-4 h-full flex items-center break-normal font-medium text-blue-500 dark:text-blue-400 border border-gray-300 hover:border-gray-400 dark:border-dark-650 dark:hover:border-dark-450 rounded-l-lg transition-colors duration-150 relative hover:z-5" href="../../self-improvement/meditation/">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="mr-3" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" overflow="visible"><path d="M19 11H7.41l5.29-5.29a.996.996 0 10-1.41-1.41l-7 7a1 1 0 000 1.42l7 7a1.024 1.024 0 001.42-.01.996.996 0 000-1.41L7.41 13H19c.55 0 1-.45 1-1s-.45-1-1-1z" /><path fill="none" d="M0 0h24v24H0z" /></svg>
                                            <span>
                                                <span class="block text-xs font-normal text-gray-400 dark:text-dark-400">Previous</span>
                                                <span class="block mt-1">Meditation</span>
                                            </span>
                                        </a>
                                    </div>
                            
                                    <div class="w-1/2">
                                        <a class="px-5 py-4 -mx-px h-full flex items-center justify-end break-normal font-medium text-blue-500 dark:text-blue-400 border border-gray-300 hover:border-gray-400 dark:border-dark-650 dark:hover:border-dark-450 rounded-r-lg transition-colors duration-150 relative hover:z-5" href="../../non-piracy-stuff/lock-hide-folders/">
                                            <span>
                                                <span class="block text-xs font-normal text-right text-gray-400 dark:text-dark-400">Next</span>
                                                <span class="block mt-1">Lock & Hide Folders</span>
                                            </span>
                            ...
                            <footer class="flex flex-wrap items-center justify-between">
                                <div>
                                    <ul class="flex flex-wrap items-center text-sm">
                                        <li>
                                            <a class="inline-flex items-center mr-4 py-2 text-sm whitespace-nowrap transition-colors duration-200 ease-linear text-blue-500 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-200 md:mb-0" href="https://discord.gg/cH3ZkVc3Gd">
                                                <img class="mb-px mr-1" width="18" alt="" src="../../static/discord.svg" />
                                                <span>Discord</span>
                                            </a>
                                        </li>
                                ...
                                <div class="docs-copyright py-2 text-gray-500 dark:text-dark-350 text-sm leading-relaxed"><p><span class="docs-emoji">&#x1F3F4;&#x200D;&#x2620;&#xFE0F;</span> Piracy is forever.</p></div>
                            </footer>
                        </div>
                    </div>
    ...
    <script>window.__DOCS__ = { "title": "File Hosting & Storage", level: 2, icon: "file", hasPrism: false, hasMermaid: false, hasMath: false }</script>
<!-- Cloudflare Pages Analytics --><script defer src='https://static.cloudflareinsights.com/beacon.min.js' data-cf-beacon='{"token": "49f4ea4bd6c64900854af9fd12e58587"}'></script><!-- Cloudflare Pages Analytics --></body>
</html>
